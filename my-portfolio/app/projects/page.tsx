...
export default function ProjectsPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-slate-950 dark:to-slate-900 transition-colors flex items-center justify-center">
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-slate-950 dark:to-slate-900 transition-colors">
      <div className="container mx-auto px-4 pt-24 pb-20">
        ...
        <div className="max-w-6xl mx-auto mb-8">
          <div className="flex gap-4 border-b border-gray-200 dark:border-slate-700 justify-center">
            <button
        ...
        {activeTab === 'projects' && (
          <div className="max-w-6xl mx-auto">
            ...
            {featuredProjects.length > 0 && (
              <div className="mb-12">
                <h2 className="text-2xl font-semibold text-gray-900 dark:text-slate-100 mb-6">Featured Projects</h2>
                <div className="grid md:grid-cols-2 gap-6">
                  {featuredProjects.map((project) => (
                    <Link
                      key={project.slug}
                      href={`/projects/${project.slug}`}
                      className="group bg-white dark:bg-slate-800 rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-200 dark:border-slate-700 overflow-hidden block"
                    >
                      {/* Project Icon/Image */}
                      ...
                      <div className="p-6">
                        ...
                        <div className="flex gap-3">
                          {project.github && (
                            <span className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-700 dark:text-slate-200 bg-gray-100 dark:bg-slate-700 rounded-lg">
                          ...
                          {project.demo && (
                            <span className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 dark:hover:bg-blue-500 transition-colors">
            ...
            {otherProjects.length > 0 && (
              <div>
                <h2 className="text-2xl font-semibold text-gray-900 dark:text-slate-100 mb-6">Other Projects</h2>
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {otherProjects.map((project) => (
                    ...
                    >
                      ...
                      <div className="p-6">
                        <h3 className="text-lg font-semibold text-gray-900 dark:text-slate-100 mb-2 group-hover:text-blue-600 dark:group-hover:text-blue-300 transition-colors">
                          {project.title}
                        </h3>
                        ...
                        <div className="flex flex-wrap gap-2 mb-4">
                          {project.technologies.slice(0, 3).map((tech) => (
                            <span
                              key={tech}
                              className="px-2 py-1 text-xs font-medium bg-gray-100 dark:bg-slate-700 text-gray-700 dark:text-slate-200 rounded-full"
                            >
                              {tech}
                            </span>
                          ))}
                        ...
                        <div className="inline-flex items-center gap-2 text-sm font-medium text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300">
                          View Project
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {projects.length === 0 && (
              <div className="text-center py-20">
                ...
                <p className="text-gray-600 dark:text-slate-400">Check back soon for new projects!</p>
              </div>
            )}
          </div>
        )}
          ...
          <div className="max-w-6xl mx-auto">
            {hackathons.length > 0 ? (
                ...
                {hackathons.map((hack) => (
                  ...
                  >
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-gray-600 dark:text-slate-400 mb-4">{hack.description}</p>
                      ...
                      <div className="flex gap-3">
                        ...
                        {hack.demo && (
                          <span className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-purple-600 rounded-lg hover:bg-purple-700 dark:hover:bg-purple-500 transition-colors">
                            View Project
                          </span>
                        )}
                      </div>
              ...
              <div className="text-center py-20">
                ...
                <p className="text-gray-600 dark:text-slate-400">Check back soon for hackathon projects!</p>
              </div>
            )}
          </div>
        )}
